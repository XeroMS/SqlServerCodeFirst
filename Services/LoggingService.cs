...
namespace Services
{
    ...
    public partial class LoggingService : ILoggingService
    {
        ...
        private const string LogFileDirectory = @"./";
        ...
        public LoggingService()
        {
            ...
            _logFileFolder = Path.GetFullPath(LogFileDirectory);
        ...
        private static string MakeLogFileName(bool isArchive)
        {
            return !isArchive ? $"{_logFileFolder}//{LogFileNameOnly}{LogFileExtension}"
                : $"{_logFileFolder}//{LogFileNameOnly}_{DateTime.UtcNow:ddMMyyyy_hhmmss}{LogFileExtension}";
        }
        ...
        /// </summary>
        public void Initialize(int maxLogSize)
        {
