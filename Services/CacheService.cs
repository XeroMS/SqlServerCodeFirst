...
namespace Services
{
    public partial class CacheService : ICacheService
    {
        ...
        public THelper CachePerRequest<THelper>(string cacheKey)
        {
            ...
            {
                if (!Domain.AppContext.Current.Items.Contains(cacheKey))
                {
                    return default(THelper);
                }
                return (THelper)Domain.AppContext.Current.Items[cacheKey];
            }
            return default(THelper);
        }
        ...
        public void SetPerRequest(string cacheKey, object objectToCache)
        {
            if (Domain.AppContext.Current != null)
            {
                Domain.AppContext.Current.Items.Add(cacheKey, objectToCache);
            }
        }
